...
async function addComment(e) {
	...
	let resp = await fetch('/api/postComment', {
		method:'post',
		headers: {
...
async function loadComments() {
	let resp = await fetch('/api/getComments?film='+window.filmId);
